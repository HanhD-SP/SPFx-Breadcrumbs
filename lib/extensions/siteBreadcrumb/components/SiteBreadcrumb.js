...
var SiteBreadcrumb = /** @class */ (function (_super) {
    ...
    SiteBreadcrumb.prototype._generateLinks = function () {
        ...
        var route = rootUrl.replace(this.props.context.pageContext.web.absoluteUrl, "");
        ...
        var title = segments.filter(function (s) { return Boolean(s) && ['SitePages', 'AllItems'].indexOf(s) === -1; }).map(function (url) { return decodeURIComponent(url); }).join(" > ");
